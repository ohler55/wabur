...
Not shown but introduced in later lessons is the `conf` directory. This
directory includes configuration files for the Runners.
...
<html>
  ...
  <body>
    ...
    <script src="http://www.wab.systems/ref/latest/assets/js/wab.js"></script>
  </body>
</html>
```
